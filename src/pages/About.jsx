    ...
    <div>
        ...
        <main className="main">
            ...
            <div className="page-content pb-3">
                    ...
                    <div className="row">
                        <div className="col-lg-10 offset-lg-1">
                            <div className="about-text text-center mt-3">
                                <h2 className="title text-center mb-2">Who We Are</h2>{/* End .title text-center mb-2 */}
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-4 col-sm-6">
                            <div className="icon-box icon-box-sm text-center">
                                ...
                                <div className="icon-box-content">
                                    <h3 className="icon-box-title">Design Quality</h3>{/* End .icon-box-title */}
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="icon-box icon-box-sm text-center">
                                ...
                                <div className="icon-box-content">
                                    <h3 className="icon-box-title">Professional Support</h3>{/* End .icon-box-title */}
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="icon-box icon-box-sm text-center">
                                ...
                                <div className="icon-box-content">
                                    <h3 className="icon-box-title">Made With Love</h3>{/* End .icon-box-title */}
                ...
                <div className="mb-2"></div>{/* End .mb-2 */}
                        ...
                        <div className="row">
                            <div className="col-6 col-md-3">
                                <div className="count-container text-center">
                                    ...
                                    <h3 className="count-title text-white">Happy Customer</h3>{/* End .count-title */}
                            ...
                            <div className="col-6 col-md-3">
                                <div className="count-container text-center">
                                    ...
                                    <h3 className="count-title text-white">Years in Business</h3>{/* End .count-title */}
                                </div>{/* End .count-container */}
                            </div>{/* End .col-6 col-md-3 */}
                            ...
                            <div className="col-6 col-md-3">
                                <div className="count-container text-center">
                                    ...
                                    <h3 className="count-title text-white">Return Clients</h3>{/* End .count-title */}
                                </div>{/* End .count-container */}
                            </div>{/* End .col-6 col-md-3 */}
                            ...
                            <div className="col-6 col-md-3">
                                <div className="count-container text-center">
                                    ...
                                    <h3 className="count-title text-white">Awards Won</h3>{/* End .count-title */}
                                </div>{/* End .count-container */}
                            </div>{/* End .col-6 col-md-3 */}
                        </div>{/* End .row */}
                    </div>{/* End .container */}
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-6 col-lg-3">
                                <div className="member member-2 text-center">
                                    ...
                                    <div className="member-content">
                                        <h3 className="member-title">Mark Pocket<span>Product Manager</span></h3>{/* End .member-title */}
                                    </div>{/* End .member-content */}
                                </div>{/* End .member */}
                            </div>{/* End .col-lg-3 */}
                            ...
                            <div className="col-sm-6 col-lg-3">
                                <div className="member member-2 text-center">
                                    ...
                                    <div className="member-content">
                                        <h3 className="member-title">Damion Blue<span>Sales & Marketing Manager</span></h3>{/* End .member-title */}
                                    </div>{/* End .member-content */}
                                </div>{/* End .member */}
                            </div>{/* End .col-lg-3 */}
                            ...
                            <div className="col-sm-6 col-lg-3">
                                <div className="member member-2 text-center">
                                    ...
                                    <div className="member-content">
                                        <h3 className="member-title">Lenard Smith<span>Product Manager</span></h3>{/* End .member-title */}
                                    </div>{/* End .member-content */}
                                </div>{/* End .member */}
                            </div>{/* End .col-lg-3 */}
                            ...
                            <div className="col-sm-6 col-lg-3">
                                <div className="member member-2 text-center">
                                    ...
                                    <div className="member-content">
                                        <h3 className="member-title">Rachel Green<span>Product Manager</span></h3>{/* End .member-title */}
                                    </div>{/* End .member-content */}
                                </div>{/* End .member */}
                            </div>{/* End .col-lg-3 */}
                            ...
                            <div className="col-sm-6 col-lg-3">
                                <div className="member member-2 text-center">
                                    ...
                                    <div className="member-content">
                                        <h3 className="member-title">David Doe<span>Product Manager</span></h3>{/* End .member-title */}
                                    </div>{/* End .member-content */}
                                </div>{/* End .member */}
                            </div>{/* End .col-lg-3 */}
                        </div>{/* End .row */}
